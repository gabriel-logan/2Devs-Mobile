...
export default function CreditCardValidatorPage() {
	...
	const [creditCardIsValidResult, setCreditCardIsValidResult] =
		useState<boolean>();
	...
	return (
		<View style={stylesWithTheme.container}>
			<Text style={stylesWithTheme.title}>
				{t("Validador de Cartão de crédito")}
			</Text>
			<View style={stylesWithTheme.card}>
				<Text style={stylesWithTheme.label}>
					{t("Digite ou cole um Cartão de crédito:")}
				</Text>
				<TextInput
				...
				/>
				<Button
					title={t("Validar Cartão de crédito")}
					onPress={validateCreditCard}
				/>
